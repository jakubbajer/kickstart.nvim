return {
  ...
  {
    'Niektórzy twierdzą, że każda, absolutnie każda rzecz na swiecie ma sowją cenę. To nieprawda. Są rzeczy, które ceny nie mają, są bezcenne. Najłatwiej poznać takie rzeczy po tym, że raz utracone, są utracone na zawsze.',
    '',
    'Andrzej Sapkowski, Chrzest ognia',
  },
  {
